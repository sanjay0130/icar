                ...
                <div class="col-sm-12">
                    <div class="card">
                        <div class="card-body">
                                    ...
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12 col-xlg-9 col-md-12">
                                                <div class="card">
                                                    <h5 style="color:#D35400;">FAQ Info</h5>
                                                    <div class="card-body">
                                                        <form id="faq_name_form" name="faq_name_form" enctype="multipart/form-data" class="form-inline">
                                                            ...
                                                            <button type="button" class="btn btn-primary mb-2" onclick="create_faq();">Submit</button>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <h5 style="color:#fff;background:#5DADE2 ;padding:8px;">FAQ Details
                            </h5>
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header table1">
                        <h5 class="modal-title text-white" id="exampleModalLabel">Update FAQ</h5>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <form id="modal_form_update" name="modal_form_update" class="form-inline">
                                                ...
                                                <textarea name="desc_up" id="desc_up"></textarea>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" onclick="upd_faq()">Save changes</button>
                    </div>
                </div>
            </div>
        </div>
