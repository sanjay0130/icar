  ...
  <section class="teamAll">
    <div class="container">
      ...
      <div class="row" id="team_member_id">
        <!-- <div class="col-sm-4">
          <div class="teamBoy">
            <figure><img src="img/team2.png" alt=""></figure>
            <div class="tyBody">
              <h4>Mr. Radhakrushna Senapati<small>Senior Reaserch Fellow</small></h4>
            </div>
          </div>
        </div> -->
       <!--  <div class="col-sm-4">
          <div class="teamBoy">
            <figure><img src="img/team1.png" alt=""></figure>
            <div class="tyBody">
              <h4>Mr. Subhendu Shekhar Pradhan<small>Computer Assistant</small></h4>
            </div>
          </div>
        </div> -->
      </div>
